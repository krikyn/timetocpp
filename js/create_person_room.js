function create_room(canvas_name,after_rigist){
	...
	var text_quote = new fabric.Text(random_str(spisok_quote), {fontSize: 80,left: -20,top: 480, fill: '#262626',fontWeight: 'bold',fontStyle: 'italic', fontFamily: 'Delicious',textAlign: 'left',  lineHeight: 0.9});
